...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4 bg-light">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="index.php?action=medicos_create" class="btn btn-primary"><i class="fas fa-plus me-2"></i>Nuevo Médico</a>
        </div>
                        ...
                        <?php else: ?>
                            <?php foreach($medicos as $medico): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-info"><?php echo htmlspecialchars($medico['especialidad'] ?? 'Sin especialidad'); ?></span>
                                    </td>
                                    <td><?php echo date('d/m/Y', strtotime($medico['fecha_registro'])); ?></td>
                                    <td>
                                        <a href="index.php?action=medicos_edit&id=<?php echo $medico['id']; ?>" class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="index.php?action=medicos_delete&id=<?php echo $medico['id']; ?>" 
