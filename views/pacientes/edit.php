...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4 bg-light">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="index.php?action=pacientes" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Volver</a>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="index.php?action=pacientes_update" method="POST">
                    <input type="hidden" name="id" value="<?php echo $paciente['id']; ?>">
                    <div class="mb-3">
                        <label class="form-label">Nombre Completo *</label>
                        <input type="text" name="nombre" class="form-control" value="<?php echo htmlspecialchars($paciente['nombre_completo']); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Email *</label>
                        <input type="email" name="email" class="form-control" value="<?php echo htmlspecialchars($paciente['email']); ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="telefono" class="form-control" value="<?php echo htmlspecialchars($paciente['telefono'] ?? ''); ?>">
                    </div>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="index.php?action=pacientes" class="btn btn-secondary">Cancelar</a>
